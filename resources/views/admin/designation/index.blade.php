...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right">
            @if(!$groups->isEmpty())
                <a href="javascript:;" id="designation-setting" class="btn btn-outline btn-success btn-sm">@lang('app.add') @lang('app.menu.designation') <i class="fa fa-plus" aria-hidden="true"></i></a>
            @endif
            <ol class="breadcrumb">
        ...
        $(function() {
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    text: "@lang('messages.removeDesignation')",
                    type: "warning",
