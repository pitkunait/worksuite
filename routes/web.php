...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        Route::get('leadCategory/create-cat', ['uses' => 'LeadCategoyController@createCat'])->name('leadCategory.create-cat');
        Route::post('leadCategory/store-cat', ['uses' => 'LeadCategoyController@storeCat'])->name('leadCategory.store-cat');
    ...
    Route::group(
        ...
        Route::get('project-template/data', ['uses' => 'ProjectTemplateController@data'])->name('project-template.data');
        Route::resource('project-template', 'ProjectTemplateControladmin/settings/email-settingsler');
